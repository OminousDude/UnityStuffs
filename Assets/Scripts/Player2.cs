...
public class Player2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        horizontal = Convert.ToSingle(Input.GetKey(KeyCode.RightArrow)) - Convert.ToSingle(Input.GetKey(KeyCode.LeftArrow));
        ...
        if (Input.GetKeyDown(KeyCode.UpArrow) && (isGrounded() || canDoubleJump))
        {
